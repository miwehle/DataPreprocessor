...
def plot_token_pair_length_histogram(
    ...
    de_lengths, en_lengths = base.load_pair_lengths(dataset_path, _extract_token_pair_lengths, progress)
...
def main() -> None:
    run("../artifacts/datasets/tedtalks/preprocessed/staging/iwslt2017-de-en_tokenize.jsonl")
