...
def _records(dataset_path: str | Path):
...
def load_pair_lengths(dataset_path: str | Path, extract_lengths) -> tuple[list[int], list[int]]:
    de_lengths, en_lengths = [], []
    for record in _records(dataset_path):
